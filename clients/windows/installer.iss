...
[Run]
; shellexec: launch via ShellExecuteEx so the app's requireAdministrator
; manifest triggers a proper UAC elevation instead of failing with
; CreateProcess error 740 (ERROR_ELEVATION_REQUIRED).
